...
public class DDiningMessageRecord extends TableRecordImpl<DDiningMessageRecord> implements Record3<Date, Integer, String> {

    private static final long serialVersionUID = -370102867;
